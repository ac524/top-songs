    ...
    findSongsByArtist() {
        ...
        return this
            ...
            .then( (response) => {
                ...
                return store.getSongsByArtist( response.artist );
    ...
    getSongRange() {
        ...
        return this
            ...
            .then( (response) => {
                ...
                return store.getTopSongsRange( response.startPosition, response.endPosition );
    ...
    getSong() {
        ...
        return this
            ...
            .then( (response) => {
                ...
                return store.getSong( response.song );
